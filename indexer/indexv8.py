        ...
        "assets": [
            {
                ...
                "base_extension": str,
                "files": {
                    // Organized by table name, each containing arrays of file records
                    "archives": [...],
                    "models_preinstanced": [...],
                    "models_blend": [...],
                    // etc.
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Universal Permutation Indexer v8 - Builds and indexes all game file permutations with improved schema"
    )
    parser.add_argument(
        '--json',
        action='store_true',
    ...
    print("--- Universal Permutation Indexer v8 ---")
    ...
    for perm in PERMUTATIONS:
        ...
        batch_by_table = {}  # Organize batches by table
